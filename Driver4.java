public class Driver4 {
    public static void main(String[] args) {
        ...
        System.out.println(Q3 + " ?= 3/2"); // another error got 1/0 what
        System.out.println(Q4 + " ?= -4/3");
        System.out.println(new RationalNumber(35, 0) + " ?= 0\n\n8.");
        //8
        System.out.println(Q1.add(Q3) + " ?= 21/10"); // getting 0.0
        System.out.println(Q2.add(Q4) + " ?= 67/6"); //errors onwards divide by 0.
